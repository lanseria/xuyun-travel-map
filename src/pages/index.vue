...
<template>
  <div class="ui-container grow flex-shrink-0 flex flex-col md:flex-row w-full relative overflow-x-hidden h-full">
    <MapComp class="map grow shrink-0 top-0 bottom-0 left-0 basis-0 transition-all duration-300 mapboxgl-map mode-simple_select mouse-drag" :class="{ 'basis-0': collapsed, 'basis-full': !collapsed }" />
